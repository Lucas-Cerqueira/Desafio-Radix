...
def plot_temp(temp_y, temp_x, axis=None, show=False):
	...
	if (not axis):
		plt.figure()
		plt.plot (input_data[target_data == 0,temp_x-1], input_data[target_data == 0,temp_y-1], 'r*', label='Estado regular')
		plt.plot (input_data[target_data == 1,temp_x-1], input_data[target_data == 1,temp_y-1], 'bo', label='Estado ótimo')
		...
		axis.plot (input_data[target_data == 0,temp_x-1], input_data[target_data == 0,temp_y-1], 'r*', label='Estado regular')
		axis.plot (input_data[target_data == 1,temp_x-1], input_data[target_data == 1,temp_y-1], 'bo', label='Estado ótimo')
